...
@section('content')
    ...
    {{-- Search --}}
    <label class="input text-white bg-[#0009] w-58 md:w-[430px] outline outline-white mb-10">
    ...
    <div class="overflow-x-auto mb-15 rounded-box border border-base-content/5 bg-black/50 text-white">
        <table class="table">
            <!-- head -->
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="" class="btn btn-xs btn-outline btn-error"><svg
                                    xmlns="http://www.w3.org/2000/svg" class="size-4" fill="currenColor"
                                    viewBox="0 0 256 256">
                                    <path
